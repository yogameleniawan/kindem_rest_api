    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form class="text-left border border-light p-5" action="{{route('courses.store')}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control  " placeholder="Indonesian"
                                id="indonesia_text" name="indonesia_text" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control  " placeholder="English"
                                id="english_text" name="english_text" required>
                        </div>
                    </div>
